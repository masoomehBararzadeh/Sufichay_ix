...
model = "message_sufi_chai"
scen = "configuration_test"
annot = "developing the sufi_chai basin model" 
...
comment = 'initial test commit for sufi_chai model'
scen$commit(comment)
scen$set_as_default()

scen$to_gdx( paste( sufi_chai_ix_path, '/model/data', sep=''), paste( 'MSGdata_', scname, '.gdx',sep='') )
